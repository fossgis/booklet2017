...
\label{osm-samstag}
Am Samstag, den 25. März findet von 10:00 bis 18:00 Uhr der OSM-Samstag statt.
...
weiteren Umkreis von Passau und natürlich an alle Teilnehmer der am Vortag
endenden FOSSGIS-Konferenz. Um eine Anmeldung wird gebeten -- entweder im OSM-Wiki unter
https://wiki.openstreetmap.org/\allowbreak wiki/\allowbreak F\allowbreak O\allowbreak SS\allowbreak GIS\_\allowbreak 2017/\allowbreak OSM-Samstag oder am Welcome Desk.

Folgende Themen wurden im OSM-Wiki schon vorgeschlagen:
\begin{itemize}
  \RaggedRight
  \setlength{\itemsep}{-1pt}
  \item \emph{blutsauger:} Freifunk -- Technik, OSM-Bezug, Big-Data/Social Media
  \item \emph{Daniel J H:} OSRM Hands-On, Setup, Fragerunde, Ideen und Feedback 
  %\item \emph{Daniel J H:} Building LiDAR apps, I will bring and give away some Sweep LiDARs, Linux Laptop and creativity required ;)
  \item \emph{Jochen Topf:} Areas-Workshop
  \item \emph{Michael Reichert:} Vorstellung und Diskussion einer Richtlinie für organisiertes Editieren
  \item \emph{Karl-Josef Adler:} 3D-Rendern von OSM-Daten
  \item \emph{rurseekatze:} Ideen für einfacheres ÖPNV-Mapping
\end{itemize}
\vfill
\justifying
\newpage

\input{sponsorentexte/204-geofabrik.tex}
\vfill
\input{sponsorentexte/401-oreilly}
\vfill
\input{sponsorentexte/205-optitool}

\input{sponsorentexte/206-terrestris}
\vfill
\input{sponsorentexte/402-osgeo-live}
